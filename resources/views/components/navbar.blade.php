    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-2 text-zinc-900 group">
                ...
                <span class="font-bold text-xl tracking-tight">DocuRent<span class="text-rose-500">.</span></span>
            </a>

            <!-- Search Bar (Desktop) -->
            <form action="{{ route('home') }}#catalog" method="GET" class="hidden md:flex flex-1 max-w-lg mx-8 relative group">
